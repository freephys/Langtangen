...
import Gnuplot, time, commands, sys
try:
...
def ic_vectorized(u, um, I, f, bc, x, y, xv, yv, t, Cx2, Cy2, dt):
    nx, ny = len(x)-1, len(y)-1
    dt2 = dt*dt
    ...
    um = bc_vectorized(um, bc, x, y, t+dt)
    return u, um
    

def scheme_vectorized(up, u, um, f, xv, yv, t, Cx2, Cy2, dt2, t_old):
